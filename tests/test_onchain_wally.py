...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "VJLApqRQPjHdBtTUQbWkePvmhU3p4SYfcRqX3BbxUpiKG3jfSW19oFULizTF7SPkcZp4uBf8TFMyu369",
            NETWORKS[0],
        ),
        (
            "VTq4Wry5xzh7PzGsF3tqDDA3NveNzZjUEUZM4T5tUVgCBvnebMCiW8jYuZmb858dSU2bYVmZEZQu5jPG",
            NETWORKS[0],
        ),
        (
        ...
        (
            "vjTudrrmqMSaEiMthDRwQbcPiGqUU7HwwVr243mgfeuRFJ8SoUkXDnTvHRtUPg3yaReoFSeHSyCq7XwW",
            NETWORKS[1],
        ),
        (
            "vtSLD2eP5njy5Fkh7q58H9s2wGsRytGLLfWmzfnbRpVYvQDYhnxDEtdZZDBzuTkj72Fz16YXCQGSyFE8",
            NETWORKS[1],
        ),
        (
